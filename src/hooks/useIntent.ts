...
/** The Cloudflare Worker that holds the OpenRouter key (see worker/). Unset means offline. */
const JEV_ENDPOINT = process.env.NEXT_PUBLIC_JEV_ENDPOINT ?? "";
const USE_MOCK = process.env.NEXT_PUBLIC_USE_MOCK === "true" || !JEV_ENDPOINT;
